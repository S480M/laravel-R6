      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('classes.store')}}" method="POST" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="E.g:Sports" class="form-control py-2" name="className" value="{{old('className')}}"/>
              @error('className')
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="number" step="0.1" placeholder="Enter price" class="form-control py-2" name="capacity" value="{{old('capacity')}}" />
              @error('capacity')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror  
            </div>
          ...
          <div class="form-group mb-3 row">
              <label for="" class="form-label col-md-2 fw-bold text-md-end"
                >Time:</label>
              <div class="col-md-10">
                <label for="" class="form-label">From <input type="time" class="form-control" name="timeFrom" value="{{old('timeFrom')}}"  ></label>
                @error('timeFrom')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror  
                <label for="" class="form-label">To <input type="time" class="form-control" name="timeTo" value="{{old('timeTo')}}" ></label>
                @error('timeTo')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror  
              </div>
