  ...
  <main>
    <div class="container my-5">
      <div class="bg-light p-5 rounded">
        <h2 class="fw-bold fs-2 mb-5 pb-2">Upload Car</h2>
        <form action="{{route('cars.upload')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          @csrf
          ...
          <div class="bg-light rounded-circle w-75 mx-auto p-3">
              <img class="img-fluid rounded-circle" src="assets/images" alt="" name="image" value="{{old('image')}}" >
              @error('image')
                <div class="alert alert-warning">{{$message}}</div>
              @enderror 
          </div>
